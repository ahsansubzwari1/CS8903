...
1. **101 first** — it's the proof of concept, and 101-01 already exists. Closing the 101-02 gap (OnDemand/SSH login) makes this module actually complete.
2. **201 second** — highest value for new researchers, and 201-05 is the most involved file in the whole repo (hybrid Scribe + code), worth tackling once you have a rhythm from 101.
3. **301 and 401** — mostly Markdown References/Explainer, no new Scribes required except 401-01 pending confirmation — these can move faster once the pattern is established.
